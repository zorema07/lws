		...
		<div class="panel panel-default" >
			<div class="panel-heading" ><h4><span class="pull right">Create Categories</h4></span></div>
				<div class="panel-body">
					...
					{{Form::open(array('url'=>route('gallery-categories.store'),'method'=>'post','class'=>'form-horizontal','files'=>true))}}
					...
					<div class="col-md-6">
						...
						{{Form::select('parent_id', array(''=>'Select Category')+$categories, '', array('class' => 'input-sm form-control','style' => 'width:200px'))}}
