        ...
        <li class="nav-header"> <a href="#" data-toggle="collapse" data-target="#userMenu">
          <h5>Settings <i class="glyphicon glyphicon-chevron-down"></i></h5>
            ...
            <ul class="list-unstyled collapse in" id="userMenu">
                ...
                <li><a href="{{ URL::route('gallery-categories.index') }}"><i class="glyphicon glyphicon-envelope"></i> Gallery Category <span class="badge badge-info">4</span></a></li>
                <li><a href="{{ URL::route('gallery.index') }}"><i class="glyphicon glyphicon-cog"></i> Gallery</a></li>
                <li><a href="{{ URL::route('post-categories.index') }}"><i class="glyphicon glyphicon-comment"></i> Post Category</a></li>
                <li><a href="{{ URL::route('post.index') }}"><i class="glyphicon glyphicon-user"></i> Post</a></li>
